...
| Tool | Purpose | Latest |
|---|---|---|
| [`jaah-vm/`](jaah-vm/) | Mini AWS-EC2-style VM launcher for the cluster (Ubuntu 26.04 LTS cloud-init) | [`jaah-vm/v0.4.0`](https://github.com/jaahit/pm-scripts/tree/jaah-vm/v0.4.0/jaah-vm) |
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/jaahit/pm-scripts/main/bootstrap.sh)" -- jaah-vm --ref jaah-vm/v0.4.0
