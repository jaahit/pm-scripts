...
| Tool | Purpose | Latest |
|---|---|---|
| [`jaah-vm/`](jaah-vm/) | Proxmox VM launcher for the cluster (Ubuntu 26.04 LTS cloud-init) | [`jaah-vm/v0.6.6`](https://github.com/jaahit/pm-scripts/tree/jaah-vm/v0.6.6/jaah-vm) |
