...
echo "    3. jaah-vm wizard                                       # ★ interactive 7-step"
echo "    4. jaah-vm create --name test-01 --type tiny --dry-run"
echo "    5. jaah-vm create --name test-01 --type tiny --start --wait-ssh"
echo "══════════════════════════════════════════════════════════════════════"
